...
interface CredentialFieldProps {
  ...
  placeholder?: string;
  hint?: string;
  /** Use true only for actual secrets (client secret, API key) — not for IDs/GUIDs */
  secret?: boolean;
}
  ...
  return (
    <div>
      ...
      <input
        ...
        placeholder={configured ? (secret ? '••••••••  (leave blank to keep current)' : '(saved – paste new value to replace)') : placeholder}
        value={value}
